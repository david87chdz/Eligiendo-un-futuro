...
INSERT INTO `usuario` VALUES (1,1,'AVE MARIA',NULL,'34001728@educa.jcyl.es','avemaria'),(2,1,'PAN Y GUINDAS',NULL,'34003257@educa.jcyl.es','panyguindas'),(3,1,'CIUDAD DE BUENOS AIRES',NULL,'34003026@educa.jcyl.es','buenosaires'),(4,1,'HÉROES DE LA INDEPENDENCIA',NULL,'34002563@educa.jcyl.es','heroes'),(5,4,'DAVID','CEREZO HERNÁNDEZ','eligiendounfuturo@gmail.com','david'),(6,5,'pruebas',NULL,'pruebas@pruebas.com','pruebas');
...
-- Dump completed on 2024-04-09 23:08:57
